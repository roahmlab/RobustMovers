#ifndef CONTROLLER_ADAPTIVE_PYBINDWRAPPER_HPP
#define CONTROLLER_ADAPTIVE_PYBINDWRAPPER_HPP
...
class kinova_controller_adaptive_pybindwrapper {
public:
    ...
    controller_adaptive::parameters params; //!< Controller parameters.

    std::shared_ptr<controller_adaptive> controllerPtr_; //!< Pointer to the controller.
    ...
    kinova_controller_adaptive_pybindwrapper(const std::string& urdf_filename,
